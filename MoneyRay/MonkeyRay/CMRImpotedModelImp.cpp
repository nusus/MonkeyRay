...
MR::CMRImpotedModelImp::CMRImpotedModelImp(const string& stdName) :
	m_strMeshName(CMRConfig::Instance()->s_strModelDir + stdName)
{

}

MR::CMRImpotedModelImp::~CMRImpotedModelImp()
{

}

bool MR::CMRImpotedModelImp::LoadMesh()
{
	bool ret = false;
...
void MR::CMRImpotedModelImp::Render()
{
	GLuint va;
...
bool MR::CMRImpotedModelImp::_InitFromScene(const aiScene* pScene, const string& strFileName)
{
...
void MR::CMRImpotedModelImp::PrintVertex(std::ofstream& outfile, const Vertex& vertex, unsigned int index) const
{
...
void MR::CMRImpotedModelImp::_InitMesh(unsigned int uiIndex, const aiMesh* paiMesh)
{
...
bool MR::CMRImpotedModelImp::_InitMaterials(const aiScene* pScene, const string& Filename)
{
	bool Ret = true;
...
void MR::CMRImpotedModelImp::MeshEntry::Init(const vector<Vertex>& Vertices, const vector<unsigned int>& Indices)
{
