#ifndef CMRGLExtensions_h__
#define CMRGLExtensions_h__

#include "CMRGLDefines.h"

namespace MR {

	extern   float getGLVersionNumber();

	extern   bool isExtensionInExtensionString(const char *extension, const char *extensionString);

	extern   bool isGLExtensionSupported(unsigned int contextID, const char *extension);

	extern   bool isGLExtensionOrVersionSupported(unsigned int contextID, const char *extension, float requiredGlVersion);

	extern   void* getGLExtensionFuncPtr(const char *funcName);

	extern   void setGLExtensionDisableString(const std::string& disableString);

	extern   std::string& getGLExtensionDisableString();
	...
	class   CMRGLExtensions : public CMRRef
	{
	public:
		CMRGLExtensions(unsigned int contextID);

		static CMRGLExtensions* Get(unsigned int contextID, bool createIfNotInitalized);

		static void Set(unsigned int contextID, CMRGLExtensions* extensions);
